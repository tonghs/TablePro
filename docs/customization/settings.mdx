...
description: All settings categories - General, Appearance, Editor, Keyboard, AI, Terminal, Plugins, and Account
---
...
<CardGroup cols={2}>
  <Card title="General" icon="gear">
    Language, startup, tabs, query history, updates, privacy
  </Card>
  ...
  <Card title="Editor" icon="code" href="/customization/editor-settings">
    SQL editor, data grid, pagination
  </Card>
  ...
  <Card title="Terminal" icon="terminal" href="/features/terminal#settings">
    Terminal font, theme, CLI paths, MCP server
  </Card>
  <Card title="Plugins" icon="puzzle-piece">
    Manage drivers
  </Card>
  <Card title="Account" icon="user" href="/features/icloud-sync">
...
How many rows to load on first execution in query tabs. Table tabs use page size instead.

| Setting | Default | Range |
|---------|---------|-------|
| **Enforce query result limit** | On | On / Off |
| **Row limit** | 10,000 | 100 - 500,000 |

When enabled, `SELECT` queries load up to the configured limit. If more rows exist, the status bar shows **Load More** and **Fetch All** actions.

Turn this off to load all rows at once (capped at 5M by the driver safety limit).

See [Data Grid - Progressive Loading](/features/data-grid#progressive-loading) for details.
...
## Sync Settings (Account Tab)

Manage iCloud sync from the **Account** tab in Settings. This is a Pro feature.
...
## License Settings (Account Tab)

Manage your license from the **Account** tab in Settings.

### Activating a License

1. Open **Settings** (`Cmd+,`) and select the **Account** tab
